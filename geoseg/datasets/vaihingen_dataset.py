...
class VaihingenDataset(Dataset):
    def __init__(self, data_root='vaihingen path', mode='val', img_dir='images_512', mask_dir='masks_512',
                 img_suffix='.tif', mask_suffix='.png', mosaic_ratio=0.0, img_size=ORIGIN_IMG_SIZE):
